...
class CollegeListDataHandler {
  ...
  buildURL_(itemsPerBatch) {
    return COLLEGE_LIST_ENDPT.concat(COLLEGES, AND, ACCEPTANCE_RATE, NOT, EQUAL, NULL, AND, 
      ACT_SCORE, NOT, EQUAL, NULL, AND, QUERY_FIELDS, ID, COMMA, NAME, COMMA, ACCEPTANCE_RATE, COMMA, 

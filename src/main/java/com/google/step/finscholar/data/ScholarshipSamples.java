...
public class ScholarshipSamples {
  ...
  public static Scholarship scholarshipSampleOne = 
      new Scholarship(new Scholarship.ScholarshipBuilder(NAME_1, UUID_1, SCHOOL_NAMES_1, SAMPLE_1_URL)
                    .setIsRenewable(true)
  ...
  public static Scholarship scholarshipSampleTwo = 
      new Scholarship(new Scholarship.ScholarshipBuilder(NAME_2, UUID_2, SCHOOL_NAMES_2, SAMPLE_2_URL)
                        .setIsRenewable(true)
